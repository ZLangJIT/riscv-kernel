...
LIBMEDIA_GRADLE_VERSION_STRING="Linux Kernel 6.11 v$LIBMEDIA_GRADLE_VERSION_CODE (kernel v$KERNEL_VERSION_MAJOR.$KERNEL_VERSION_MINOR)(buildroot+rootfs v$BUILDROOT_VERSION_MAJOR.$BUILDROOT_VERSION_MINOR)(epoxy v$EPOXY_VERSION_MAJOR.$EPOXY_VERSION_MINOR)(virglrenderer v$VIRGL_VERSION_MAJOR.$VIRGL_VERSION_MINOR)(rvvm v$RVVM_VERSION_MAJOR.$RVVM_VERSION_MINOR)(libmedia v$LIBMEDIA_VERSION_MAJOR.$LIBMEDIA_VERSION_MINOR)"
